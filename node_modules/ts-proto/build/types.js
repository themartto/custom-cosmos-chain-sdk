    ...
    switch (typeName) {
        ...
        case '.google.protobuf.BytesValue':
            return ctx.options.env === options_1.EnvOption.NODE
                ? ts_poet_1.code `Buffer`
                : ctx.options.useJsonWireFormat
                    ? ts_poet_1.code `string`
                    : ts_poet_1.code `Uint8Array`;
        ...
        case '.google.protobuf.FieldMask':
            return ctx.options.useJsonWireFormat ? ts_poet_1.code `string` : ts_poet_1.code `string[]`;
        case '.google.protobuf.Duration':
            return ctx.options.useJsonWireFormat ? ts_poet_1.code `string` : undefined;
